 ...
 *
 * Template for displaying a 3-Column Layout with ACF Pro
 *
 * @package understrap
 */
...
$hero_image = get_field( 'three_column_hero_image' );
...
<div class="container-fluid header-image" style="background: url('<?php echo $hero_image; ?>') no-repeat; background-size: cover; background-position: 50% 50%;">
	<?php if( get_field('three_column_hero_text') ): ?>
		<div class="page-title">
			<h1><?php the_field('three_column_hero_text'); ?></h1>
		</div>
	<?php endif; ?>
</div>
		...
		<div class="row">
				<?php if( have_rows('three_column_category_tiles') ): ?>
					<?php while( have_rows('three_column_category_tiles') ): the_row(); 
						...
						?>
						<div class="col-12 col-sm-6 col-md-4 column-container">
